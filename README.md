# Cellcounts_clocks
This repository contains the scripts used to perform the analyses described in *Jonkman et al. Blood cell composition reveals distinct biological interpretation of DNA methylation age and age acceleration*. Scripts are marked 01 to 05 to indicate the order in which they were run.

This repository contains both the raw R Markdown scripts as well as knitted HTML-reports, containing both scripts and output. These can be found in the *Knitted scripts* folder, or by using the links below:
