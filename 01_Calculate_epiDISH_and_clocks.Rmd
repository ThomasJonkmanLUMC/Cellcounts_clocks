...
In this script, the DNA-methylation data will be loaded and used to predict the following:

1) Blood cell counts, predicted by [EpiDISH](https://genomemedicine.biomedcentral.com/articles/10.1186/s13073-023-01211-5), of 12 cell fractions: neutrophils, eosinophils, basophils, monocytes, naive B cells, memory B cells, naive CD4 T cells, memory CD4 T cells, naive CD8 T cells, memory CD8 T cells, regulatory T cells, and natural killer cells.

2) Six epigenetic clocks, including three 1st-generation clocks ([Hannum](https://pmc.ncbi.nlm.nih.gov/articles/PMC3780611/), [Horvath](https://pmc.ncbi.nlm.nih.gov/articles/PMC4015143/), and [Zhang](https://genomemedicine.biomedcentral.com/articles/10.1186/s13073-019-0667-1)), and three 2nd-generation clocks ([PhenoAge](https://pmc.ncbi.nlm.nih.gov/articles/PMC5940111/), [GrimAge](https://pmc.ncbi.nlm.nih.gov/articles/PMC6366976/), and [DunedinPACE](https://elifesciences.org/articles/73420))

Additionally, correction for batch effects will be performed using ComBat, and the impact of this step will be visualized with some before-and-after plots.
